...
public interface ButtonContext extends IEventGetter<ButtonInteractionEvent>, IInteractionContext, IRepliable, IMessageable, ICommonGetter, ISendableReply, ISendableMessage {
