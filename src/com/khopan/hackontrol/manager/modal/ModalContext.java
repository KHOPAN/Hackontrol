...
public interface ModalContext extends IEventGetter<ModalInteractionEvent>, IInteractionContext, IRepliable, IMessageable, ICommonGetter, ISendableReply, ISendableMessage {
