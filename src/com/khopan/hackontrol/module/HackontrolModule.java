...
public class HackontrolModule extends Module {
	...
	public void preInitialize(Registry registry) {
		registry.register(InteractionManager.BUTTON_REGISTRY, HackontrolModule.PING_BUTTON, context -> HackontrolMessage.deletable(context.reply(), "**Status: Ok**"));
	}

	@Override
	public void initialize() {
		this.channel.sendMessageComponents(ActionRow.of(HackontrolModule.PING_BUTTON)).queue();
	}
