...
void HI_SetSettings(ITaskFolder* folder, ITaskDefinition* definition) {
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskDefinition::get_Settings()");
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_AllowDemandStart()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_RestartInterval()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_RestartCount()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_ExecutionTimeLimit()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_DisallowStartIfOnBatteries()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_StopIfGoingOnBatteries()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_RunOnlyIfNetworkAvailable()");
		settings->Release();
		definition->Release();
		folder->Release();
		CoUninitialize();
	...
	if(FAILED(result)) {
		HU_DisplayError(result, L"ITaskSettings::put_Hidden()");
		definition->Release();
		folder->Release();
		CoUninitialize();
		ExitProcess(static_cast<UINT>(result));
